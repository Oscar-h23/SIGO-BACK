...
@Entity @Table(name="relevo_checklist", uniqueConstraints=@UniqueConstraint(columnNames={"relevo_id","elemento_id"}))
@Getter @Setter @NoArgsConstructor @AllArgsConstructor
public class RelevoChecklist {
 ...
 @ManyToOne(fetch=FetchType.EAGER,optional=false) @JoinColumn(name="elemento_id",nullable=false) private ElementoRelevo elemento;
